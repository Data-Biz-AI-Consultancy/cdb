#!/usr/bin/env python3
"""
CDB — Data Migration Script: Jager `cdp` to CDB `cdb`
=====================================================
...
def main() -> None:
    ...
    parser.add_argument(
        "--source-url",
        default=os.getenv("JAGER_DATABASE_URL", "postgresql://jager:jager@localhost:5432/cdp"),
        help="Source PostgreSQL connection URL (default: JAGER_DATABASE_URL or localhost:5432/cdp)",
    )
    parser.add_argument(
        "--target-url",
