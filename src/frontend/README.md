...
2. **Pipeline & Engagements**
   ...
   - **Leads** (`/leads`): Interest qualification funnel (`New` → `Contacted` → `Qualified` → `Converted`).
   - **Opportunities** (`/opportunities`): Deal pipeline with Kanban board and stage tracking.
